...
public class ClientGlobal {
    ...
    public static void initByProperties(org.csource.fastdfs.Properties properties) throws IOException, MyException {
        Properties props = new Properties();
        props.putAll(new HashMap<String, Object>() {{
            put(PROP_KEY_TRACKER_SERVERS, properties.getTracker_servers());
            put(PROP_KEY_CONNECT_TIMEOUT_IN_SECONDS, properties.getConnect_timeout_in_seconds());
            put(PROP_KEY_NETWORK_TIMEOUT_IN_SECONDS, properties.getNetwork_timeout_in_seconds());
            put(PROP_KEY_CHARSET, properties.getCharset());
            put(PROP_KEY_HTTP_ANTI_STEAL_TOKEN, properties.isHttp_anti_steal_token());
            put(PROP_KEY_HTTP_SECRET_KEY, properties.getHttp_secret_key());
            put(PROP_KEY_HTTP_TRACKER_HTTP_PORT, properties.getHttp_tracker_http_port());
            put(PROP_KEY_CONNECTION_POOL_ENABLED, properties.getPool().isEnabled());
            put(PROP_KEY_CONNECTION_POOL_MAX_COUNT_PER_ENTRY, properties.getPool().getMax_count_per_entry());
            put(PROP_KEY_CONNECTION_POOL_MAX_IDLE_TIME, properties.getPool().getMax_idle_time());
            put(PROP_KEY_CONNECTION_POOL_MAX_WAIT_TIME_IN_MS, properties.getPool().getMax_wait_time_in_ms());
        }});
        initByProperties(props);
    }
